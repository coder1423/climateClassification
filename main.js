...
//외부파일
var 지도크기 = window.innerHeight-20; var 그래프크기 = 400; var 타일크기 = 48;
...
function 전체계산() {
  기온계산(1, 0); 기온계산(2, -기울기); 기온계산(3, 0); 기온계산(4, 기울기);
  바람방향계산(1, 0); 바람방향계산(2, -기울기); 바람방향계산(3, 0); 바람방향계산(4, 기울기);
  바다영향계산(1, 0); 바다영향계산(2, -기울기); 바다영향계산(3, 0); 바다영향계산(4, 기울기);
  기단생성();
  강수량계산(1, 0); 강수량계산(2, -기울기); 강수량계산(3, 0); 강수량계산(4, 기울기);
  기후구분();
}
